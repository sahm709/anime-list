      ...
      <div className="centered">
        <div className="modal">
          <div className="modalHeader">
            ...
            {page === "addCollection" && (
              <h2 className="heading">Add Collection</h2>
            )}
            {page === "editCollection" && (
              <h2 className="heading">Edit Collection</h2>
            )}
            {page === "deleteCollection" && (
              <h2 className="heading">Delete Collection</h2>
            )}
          </div>
          ...
          <div className="modalContent">
            ...
            {page === "editCollection" && (
              <TabsContainer>
                ...
                <button
                  className="btn"
                  onClick={() => handleEditCollectionName(newCollectionName)}
                >
                  Edit Collection
                </button>
              </TabsContainer>
            ...
            {page === "deleteCollection" && (
              <TabsContainer>
                <p className="label-existing">
                  Do you want to delete {collectionName} collection
                </p>
                <button
                  className="button-del"
                  onClick={() => handleRemoveCollection(collectionName)}
                >
                  Delete Collection
                </button>
              </TabsContainer>
