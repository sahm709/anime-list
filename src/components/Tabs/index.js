  ...
  const handleAddToNewCollection = () => {
    if (selectedCollection) {
      ...
      if (
        ...
        setErrorMessage(
          "Collection name can only contain letters, numbers, and spaces.",
        );
      } else {
      ...
      setErrorMessage(
        "Please select an existing collection or enter a collection name.",
      );
    }
    setCollectionName("");
          ...
          <div className="content">
            ...
            {currentTab === 2 && (
              <div>
                ...
                />
                <div className="button-container">
                  <button onClick={handleAddToNewCollection} className="btn">
                    Add to Collection
                  </button>
                </div>
              </div>
