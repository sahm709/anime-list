      ...
      <div className="container">
        <div>
          <div className="container-title">
            ...
            <button className="btn" onClick={() => handleAddCollection()}>
              Add Collection
            </button>
          </div>
          <div className="list">
              ...
              <div className="collection-card" key={collection.name}>
                ...
                <div className="button-card-container">
                  <img
                    src={edit}
                    alt="collections"
                    className="arrow-button btn-edit"
                    onClick={() => handleEditCollectionName(collection.name)}
                  />
                  <div className="pt-btn">
                    <img
                      src={trash}
                      alt="collections"
                      className="arrow-button btn-del"
            ...
            {isOpen && (
              <Modal
                setIsOpen={setIsOpen}
                page="addCollection"
                updateCollections={updateCollectionsCallback}
              />
            )}
            {isEdit && (
              <Modal
